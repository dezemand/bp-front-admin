...
export default class Actions extends Component {
  state = {sort: 3, showFilter: false, filter: 15};
  sortOptions = ["Alfabetisch (voornaam)", "Alfabetisch (achternaam)", "Oud naar nieuw", "Nieuw naar oud", "Code"];
  ...
  sortData = () => {
    ...
    ActionSheet.showActionSheetWithOptions({
        ...
        if(i < this.sortOptions.length) this.setState({sort: i}, () => this.props.onChange(this.state.sort, this.state.filter));
      });
  }
